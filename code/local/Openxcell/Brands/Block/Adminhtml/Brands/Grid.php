...
class Openxcell_Brands_Block_Adminhtml_Brands_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('title', array(
          'header'    => Mage::helper('brands')->__('Title of Brand'),
          'align'     =>'left',
          'index'     => 'title',
      ));
      
      $this->addColumn('brand_url', array(
          'header'    => Mage::helper('brands')->__('URL of Brand'),
          'align'     =>'left',
          'index'     => 'brand_url',
      ));
      ...
      $this->addColumn('content', array(
			'header'    => Mage::helper('brands')->__('Brand Content'),
			'width'     => '150px',
			'index'     => 'content',
      ));
	  */
